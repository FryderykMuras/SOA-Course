 ...
 * 2019-05-24T15:57:35.674+02:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "ServiceService",
                  wsdlLocation = "http://localhost:8080/Projekt1-ejb/Service?wsdl",
                  targetNamespace = "http://soa.com/")
public class ServiceService extends javax.xml.ws.Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://soa.com/", "ServiceService");
    public final static QName ServicePort = new QName("http://soa.com/", "ServicePort");
    static {
        URL url = null;
        try {
